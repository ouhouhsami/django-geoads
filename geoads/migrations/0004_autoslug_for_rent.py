...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomeForRentAd.slug'
        db.add_column('ads_homeforrentad', 'slug', self.gf('autoslug.fields.AutoSlugField')(default=datetime.date(2012, 1, 3), unique_with=(), max_length=50, populate_from=None, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HomeForRentAd.slug'
        db.delete_column('ads_homeforrentad', 'slug')
