...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomeForSaleAd.user_entered_address'
        db.add_column('ads_homeforsalead', 'user_entered_address', self.gf('django.db.models.fields.CharField')(default='null', max_length=2550), keep_default=False)

        # Adding field 'HomeForSaleAd.ad_valorem_tax'
        db.add_column('ads_homeforsalead', 'ad_valorem_tax', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'HomeForSaleAd.housing_tax'
        db.add_column('ads_homeforsalead', 'housing_tax', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'HomeForSaleAd.maintenance_charges'
        db.add_column('ads_homeforsalead', 'maintenance_charges', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'HomeForRentAd.user_entered_address'
        db.add_column('ads_homeforrentad', 'user_entered_address', self.gf('django.db.models.fields.CharField')(default='null', max_length=2550), keep_default=False)
        ...
        # Adding field 'HomeForRentAd.housing_tax'
        db.add_column('ads_homeforrentad', 'housing_tax', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'HomeForRentAd.maintenance_charges'
        db.add_column('ads_homeforrentad', 'maintenance_charges', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HomeForSaleAd.user_entered_address'
        db.delete_column('ads_homeforsalead', 'user_entered_address')

        # Deleting field 'HomeForSaleAd.ad_valorem_tax'
        db.delete_column('ads_homeforsalead', 'ad_valorem_tax')

        # Deleting field 'HomeForSaleAd.housing_tax'
        db.delete_column('ads_homeforsalead', 'housing_tax')

        # Deleting field 'HomeForSaleAd.maintenance_charges'
        db.delete_column('ads_homeforsalead', 'maintenance_charges')

        # Deleting field 'HomeForRentAd.user_entered_address'
        db.delete_column('ads_homeforrentad', 'user_entered_address')

        # Deleting field 'HomeForRentAd.ad_valorem_tax'
        db.delete_column('ads_homeforrentad', 'ad_valorem_tax')

        # Deleting field 'HomeForRentAd.housing_tax'
        db.delete_column('ads_homeforrentad', 'housing_tax')

        # Deleting field 'HomeForRentAd.maintenance_charges'
        db.delete_column('ads_homeforrentad', 'maintenance_charges')
