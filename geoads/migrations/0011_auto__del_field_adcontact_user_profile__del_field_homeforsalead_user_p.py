...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AdContact.user_profile'
        db.delete_column('ads_adcontact', 'user_profile_id')

        # Deleting field 'HomeForSaleAd.user_profile'
        db.delete_column('ads_homeforsalead', 'user_profile_id')

        # Deleting field 'AdSearch.user_profile'
        db.delete_column('ads_adsearch', 'user_profile_id')

        # Deleting field 'HomeForRentAd.user_profile'
        db.delete_column('ads_homeforrentad', 'user_profile_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AdContact.user_profile'
        raise RuntimeError("Cannot reverse this migration. 'AdContact.user_profile' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HomeForSaleAd.user_profile'
        raise RuntimeError("Cannot reverse this migration. 'HomeForSaleAd.user_profile' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AdSearch.user_profile'
        raise RuntimeError("Cannot reverse this migration. 'AdSearch.user_profile' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HomeForRentAd.user_profile'
        raise RuntimeError("Cannot reverse this migration. 'HomeForRentAd.user_profile' and its values cannot be restored.")
