...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'HomeForSaleAd', fields ['slug']
        db.create_unique('ads_homeforsalead', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HomeForSaleAd', fields ['slug']
        db.delete_unique('ads_homeforsalead', ['slug'])
