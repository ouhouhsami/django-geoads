...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'HomeForRentAd', fields ['slug']
        db.create_unique('ads_homeforrentad', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HomeForRentAd', fields ['slug']
        db.delete_unique('ads_homeforrentad', ['slug'])
